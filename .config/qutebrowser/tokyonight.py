...
c.colors.prompts.border = '0.5px solid #b4f9f8'
...
c.colors.keyhint.suffix.fg = base08
c.colors.keyhint.bg = 'rgba(31, 35, 53, 99%)'
...
# c.colors.hints.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(230, 175, 0, 0.9), stop:1 rgba(255, 109, 0, 0.9))'
c.colors.hints.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 rgba(230, 199, 0, 0.9), stop:1 rgba(255, 109, 0, 0.9))'
