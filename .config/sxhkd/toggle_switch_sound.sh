...
CARD1="alsa_output.pci-0000_01_00.1.hdmi-stereo-extra5"
CARD2="alsa_output.usb-C-Media_Electronics_Inc._USB_PnP_Sound_Device-00.iec958-stereo"
...
setCard() {
  ...
  notify-send --urgency=normal "Audio Switching" "SINK: $NEW_SINK"
}
