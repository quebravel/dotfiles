...
# wofi_command = f"echo '{output}' | fuzzel -d --placeholder='Saida de audio' -p 'Pipewire:'"
wofi_command = f"echo '{output}' | fuzzel -d --hide-prompt --width 70 --lines 5"
# wofi_command = f"echo '{output}' | rofi -dmenu -p 'Pipewire:'"
